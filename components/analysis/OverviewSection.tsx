  ...
  return (
    <section>
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <span className="overview-read-time">
          <Icon name="clock" size={13} />2 min read
        </span>
      </div>
        ...
        <div className="space-y-5">
          <article className="panel-card">
            ...
            <div className="takeaway">
              ...
              <p>{analysis.overview.takeaway}</p>
            </div>
          </article>
          <article className="panel-card">
            <h3 className="small-heading flex items-center gap-2">
            ...
            <p className="body-copy mt-3">{analysis.overview.audience}</p>
          </article>
        </div>
        <div className="space-y-5">
          <article className="panel-card complexity-card">
            <div className="flex items-center justify-between gap-2">
              <h3 className="small-heading">Complexity</h3>
              <span className="complexity-badge">
                {analysis.overview.complexity}
              </span>
            </div>
            <div className="complexity-bars" aria-hidden="true">
              <span />
              <span />
              <span />
              <span />
            ...
            <p className="text-sm leading-7 text-muted">
              {analysis.overview.complexityDescription}
            </p>
          </article>
          <div>
        ...
        {analysis.technologies.map((technology) => (
          <div className="tech-strip-item" key={technology.name}>
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-muted">{technology.category}</p>
            </div>
          </div>
        ))}
      </div>
