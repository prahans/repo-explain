...
export function ErrorState({
  ...
  description,
  onRetry,
}: ErrorContent & { onRetry?: () => void }) {
  return (
    <div className="state-surface">
      <div className="state-icon !border-[#f1d9ce] !bg-accent-soft !text-accent">
      ...
      <button type="button" className="secondary-button mt-6" onClick={onRetry}>
